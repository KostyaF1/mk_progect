...
(function($) {
	$.fn.roundCorner = function(options){
		this.each (
			function(){
				AddTop(this, options.top[0], options.top[1], options.sizex, options.sizey);
				AddBottom(this, options.bottom[0], options.bottom[1], options.sizex, options.sizey);
			}
		);
	};
})(jQuery);
